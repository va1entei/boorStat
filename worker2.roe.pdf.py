...
#  'Республика Беларусь,МОГИЛЕВСКАЯ область,Кличевский район': ['53.51677135',   '29.2998839161929'],
...
for i in df:
    ...
    for j in X:
        if str(j[0])!='Наименование' and str(j[0])!='nan' and str(j[0])!='ИТОГО':            
            tsKey = 'start'
            ...
            if ' ' in j[1]:
                ...
                c1 = j[2].split(' ')[0]                
            boorDict0_roe[tsKey] = (nz(c0))/cdv
            boorDict1_roe[tsKey] = (nz(c0)-nz(c1))/cdv
